...
@Component({
  ...
  template: `
    ...
    >
      ...
      <ng-container *ngIf="editMode === false && inputValue() === null || !editMode; else editTemplate">
        <div (click)="toggleEditMode()">
          <!-- Your display mode content here, e.g., showing the selected item -->
          <ng-container
            *ngTemplateOutlet="
              selectedItemTemplate;
              context: { $implicit: inputValue() }
            "
          ></ng-container>
        </div>
      </ng-container>
      ...
      <ng-template #editTemplate>
        <input
          *ngIf="!multiple"
          ...
          [attr.aria-aria-activedescendant]="
      ...
      <ul
        *ngIf="multiple"
        ...
        [attr.aria-activedescendant]="
          focused ? focusedMultipleOptionId : undefined
        "
        ...
        <li
          ...
          *ngFor="let option of modelValue(); let i = index"
          [ngClass]="{
            ...
            'p-focus': focusedMultipleOptionIndex() === i
          }"
        ...
        >
          ...
          <ng-template #buildInItems let-items let-scrollerOptions="options">
            ...
            >
                ...
                <ng-container *ngIf="!isOptionGroup(option)">
                  <li
                    ...
                    [ngClass]="{
                      ...
                      'p-focus':
                        focusedOptionIndex() ===
                        getOptionIndex(i, scrollerOptions),
                    ...
                    [attr.aria-posinset]="
                      getAriaPosInset(getOptionIndex(i, scrollerOptions))
                    "
              ...
              <li
                *ngIf="
                  !items || (items && items.length === 0 && showEmptyMessage)
                "
  ...
  host: {
    ...
    "[class.p-inputwrapper-focus]":
      "((focused && !disabled) || autofocus) || overlayVisible",
    ...
    ControlValueAccessor
{
   ...
   * @group Emits
   */
  @Output() completeMethod: EventEmitter<AutoCompleteCompleteEvent> =
   ...
   * @group Emits
   */
  @Output() onSelect: EventEmitter<AutoCompleteSelectEvent> =
   ...
   * @group Emits
   */
  @Output() onUnselect: EventEmitter<AutoCompleteUnselectEvent> =
    new EventEmitter<AutoCompleteUnselectEvent>();
  /**
   ...
   * @group Emits
   */
  @Output() onLazyLoad: EventEmitter<AutoCompleteLazyLoadEvent> =
    new EventEmitter<AutoCompleteLazyLoadEvent>();
  ...
  visibleOptions = computed(() => {
    return this.group
      ? this.flatOptions(this._suggestions())
      : this._suggestions() || [];
  });
  ...
  get emptySearchMessageText() {
    return (
      this.emptyMessage || this.config.translation.emptySearchMessage || ""
    );
  }

  get selectionMessageText() {
    return (
      this.selectionMessage || this.config.translation.selectionMessage || ""
    );
  }
  ...
  get emptySelectionMessageText() {
    return (
      ...
      this.config.translation.emptySelectionMessage ||
      ""
    );
  }
  ...
  onContainerClick(event) {
    ...
    if (
      ...
      !this.overlayViewChild.overlayViewChild?.nativeElement.contains(
        event.target
      )
    ) {
  ...
  onBackspaceKey(event) {
    ...
    if (
      !this.multiple &&
      this.showClear &&
      this.findSelectedOptionIndex() != -1
    ) {
      this.clear();
    }
  }
  ...
  toggleEditMode() {
    ...
    if (this.editMode) {
      setTimeout(() => this.inputElement.nativeElement.focus(), 0); // Focus on the input element when entering edit mode
    }
  }
}
